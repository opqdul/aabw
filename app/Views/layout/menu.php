                        ...
                        <li class="#"><a class="nav-link" href="blank.html"><i class="fas fa-thumbtack"></i><span>Jurnal Umum</span></a></li>
                        <li class="#"><a class="nav-link" href="blank.html"><i class="fas fa-book"></i><span>Posting</span></a></li>
                        <li class="#"><a class="nav-link" href="blank.html"><i class="fas fa-briefcase"></i><span>Neraca Saldo</span></a></li>
                        <li class="#"><a class="nav-link" href="blank.html"><i class="fas fa-chart-pie"></i><span>Neraca Lajur</span></a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="#l">Arus Kas</a></li>
                            </ul>
                        </li>